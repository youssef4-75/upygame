...
ratio = 100  # ratio to convert from fps to .01fps
...
pygame surface or a list-like of pygame surfaces""")
        ...
        self.__repeat = 100*(len(Content_list) - 1)  # mark the end frame of the animation
    
    def __len__(self):return len(self.SL)

    def __str__(self) -> str:
        return f"<Animation({len(self)}, current={self.__current//100})>"
