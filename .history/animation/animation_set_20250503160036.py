...
class AnimationSet:
    ...
    def add(self, key: int, animation: Animation|Iterable[Surface], priority: int):
        """
        add an animation to the collection, if the key is already in the collection, add the given frames to the previous one
        """
