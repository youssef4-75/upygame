...
class GifCollection[Content]:
    ...
    def add_sample_color(self, color: tuple[int, int, int], rect: Rect):
        transparent_surface = Surface((100, 100), pygame.SRCALPHA)
        transparent_surface.fill((255, 0, 0, 128))  # Semi-transparent red
