...
pygame surface or a list-like of pygame surfaces""")
        self.__start = 0  # mark the start of the animation, usefull for special animations where each time you loop you start from a different point
        self.__current = 0
    ...
    def generate(self, frame_speed):
        ...
        self.__current = int(self.__current + frame_speed) % self.__repeat
        return Surf
