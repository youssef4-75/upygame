...
class AnimationSet:
    ...
    def compare_priority(self, anim_index1, anim_index2):
        ...
        if they are different index: return first index priority is less than or equal to the second ones'

        used to define whether to stop the current animation and switch to another one or just keep with the current untill it ends 
        """
