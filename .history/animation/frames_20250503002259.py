...
class GIF:
    def __init__(self, Content_list: Iterable[Content]) -> None:
        self.SL = list(Content_list)
...
class GifCollection[Content]:
    def __init__(self, gifs: dict[int, GIF[Content]], priorities: dict[int, int], frame_speed) -> None:
        # keys are numbers
    ...
    def add(self, key: int, Gif: GIF[Content], priority: int):
