...
class Window:
    ...
    @dispatch(object, pg.Surface, tuple|pg.Rect)
    def blit(self, screen: pg.Surface, pos: tuple|pg.Rect):
        # self.screen.blit(screen, pos)
        return "bliting a surface"
    
    @dispatch(object, Collection, tuple|pg.Rect, tuple)
    def blit(self, screen: Collection, pos: tuple|pg.Rect, color: tuple):
        # self.screen.blit(screen, pos)
