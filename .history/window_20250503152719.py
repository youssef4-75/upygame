...
class Window:
    ...
    @dispatch(pg.Surface, object, object)
    def blit(self, surface: pg.Surface, pos: tuple, _=None):
        self.screen.blit(surface, pos)

    
    @dispatch(AnimationSet, object)
    def blit(self, surface: AnimationSet, pos: tuple|pg.Rect, state=N):
        self.screen.blit(surface.decide(), pos)   
