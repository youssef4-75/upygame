...
class Window:
    ...
    def __getattribute__(self, name):
        try:
            ...
            # If it's a method, return it as-is
            if callable(attr):
                return attr
                
            # For data attributes, add some processing
            return f"Processed: {attr}"
        except AttributeError:
            return f"Attribute {name} not found, but I won't raise an error!"
