...
class Board:
    ...
    @loop_method
    def activate_peace(self, mouse_pos: tuple[Column_X, Row_Y]) -> Piece:
        """
    ...
    def __add_1p(self, peace: Piece):
        self.peace.add(peace)

    @init_method
    def add_peace(self, side: int, *peaces: Piece):
