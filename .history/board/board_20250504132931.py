...
class Board:
    def __init__(self, row: Row_Y, column: Column_X,
        ...
        self.peaces = set()
        self.moving_peaces = {}
        self.__maximum_peace_to_move = 1
        self.sides = []
        self.turn = None

    @property
    def npe(self):
        return self.__maximum_peace_to_move
    
    
    @npe.setter
    def npe(self, value):
        self.__maximum_peace_to_move = value
    ...
    def activate_drag(self, mouse_pos: tuple[Column_X, Row_Y]):
